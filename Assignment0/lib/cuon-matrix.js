...
class Vector3 {
	...
	static cross(other1, other2) {
		...
		v3.elements[0] -= other1.elements[2] * other2.elements[1];
		...
		v3.elements[2] -= other1.elements[1] * other2.elements[0];
	...
	magnitude() {
		...
		for (let i = 0; i < 3; i++) {
			const pow2 = Math.pow(this.elements[i], 2);
			m += pow2;
		}
	...
	normalize() {
		...
		this.elements = this.div(mag).elements;
